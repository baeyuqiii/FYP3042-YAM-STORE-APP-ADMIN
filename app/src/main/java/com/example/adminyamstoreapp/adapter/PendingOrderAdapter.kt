package com.example.adminyamstoreapp.adapter
...
import com.example.adminyamstoreapp.databinding.PenidnigOrdersItemBinding
...
class PendingOrderAdapter(
    ...
    fun updateData(listOfName: MutableList<String>, listOfTotalPrice: MutableList<String>, listOfImageFirstFoodOrder: MutableList<String>) {
